...
| `commuter-portal` | Mobile browser (375px–428px primary, responsive up) | 5174 | `/commuter` |
...
**Modal Layout**:
Displays the RAAH System Legal Compliance Framework (refer to `LEGAL_FRAMEWORK.md` for full text). It covers Statutory Basis, Enforcement Logic, Data Protection (DPDP Act 2023), and includes a button linking to the full documentation.
```
...
|---------|--------|-------------|
| Highway line | Blue polyline following NH-275 actual route | OpenStreetMap GeoJSON + Turf.js |
...
## Commuter Portal (Mobile-Optimized Website)
...
Both frontends should use consistent colors for data categories:
...
## Demo Flow Mapping
Refer to `MAP_DEMO_SCRIPT.md` for step-by-step presentation actions.
